...
with gr.Blocks(analytics_enabled=False) as demo:
    with gr.Row():
        ...
        with gr.Column():
            gr.Video('https://github.com/myshell-ai/OpenVoice/assets/40556743/3cba936f-82bf-476c-9e52-09f0f417bb2f',
                     autoplay=True)
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            tts_button.click(predict, [input_text_gr, style_gr, ref_gr, mic_gr, use_mic_gr, tos_gr],
                             outputs=[out_text_gr, audio_gr, ref_audio_gr])
